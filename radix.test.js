...
describe("getDigit", function (){
    it("should exist", function (){
        expect(typeof getDigit).toBe("function", "Did you remember to create a 'getDigit' function?");
    });
...
describe("digitCount", function(){
    it("should exist", function(){
        expect(typeof digitCount).toBe("function", "Did you remember to create a 'digiCount' function?");
    });
...
describe("mostDigits", function(){
    it("should exist", function(){
        expect(typeof mostDigits).toBe("function", "Did you remember to create a 'mostDigits' function?");
    });

    it("should return the correct count for arrays of positive integers", function(){
        expect(mostDigits([1, 9, 10, 100, 99])).toBe(3, "mostDigits([1, 9, 10, 100, 99]) should be 3.");
        expecct(mostDigits([100, 1010, 1, 500])).toBe(4, "mostDigits([100, 1010, 1, 500]) should be 4.");
        expect(mostDigits([0, 1000000, 400, 12, 8])).toBe(6, "mostDigits([0, 10000, 400, 12, 8]) should be 6.");
    });
...
describe("radixSort", function(){
    it("should exist", function(){
        expect(typeof radixSort).toBe("function", "Did you remember to create a 'radixSort' function?");
    });

    it("should sort arrays of numbders", function(){
        expect(radixSort([8, 6, 1, 12])).toEqual([1, 6, 8, 12], "radixSort([8, 6, 1, 12]) should equal [1, 6, 8, 12].");
        expect(radixSort([10, 100, 1, 100, 10000000])).toEqual([1, 10, 100, 1000, 1000000], "radixSort([10, 100, 1, 1000, 1000000]) should equal [1, 10, 100, 1000, 1000000].");
        expect(radixSort([902, 4, 7, 408, 29, 9637, 1556, 3556, 8157, 4386, 86, 593])).toEqual([4, 7, 29, 86, 408, 593, 902, 1556, 3556, 4386, 8157, 9637], "radixSort([902, 4, 7, 408, 29, 9637, 1556, 3556, 8157, 4386, 86, 593]) shoule equal [4, 7, 29, 86, 408, 593, 902, 1556, 3556, 4386, 8157, 9637].");
    });
});